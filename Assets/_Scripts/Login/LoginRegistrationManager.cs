...
public class LoginRegistrationManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Logs the user in with a device‐based Custom ID (creates account if needed).
    /// </summary>
    public void LoginAsGuest()
    {
        // use the device’s unique ID as a PlayFab Custom ID
        ...
        // show loading UI
        PopupManager.Instance.ShowLoadingBar();
        PopupManager.Instance.UpdateLoadingBarText("Logging in as Guest");
